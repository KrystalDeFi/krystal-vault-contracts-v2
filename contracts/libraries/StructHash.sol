...
library StructHash {
  ...
  // );
  bytes32 constant TickOffsetCondition_TYPEHASH =
    0x62a0ad438254a5fc08168ddf3cb49a0b3c0e730e76f4fa785b4df532bc2dafb9;
  ...
  // );
  bytes32 constant PriceOffsetCondition_TYPEHASH =
    0xee7cf2600f91b8ddafa790dd184ce3c665f9dc116423525b336e1edac8e07e12;
  ...
  // );
  bytes32 constant TokenRatioCondition_TYPEHASH =
    0x45ae7b1ead003f850829121834fe562edded567cc66a42e8315561c98a7735f9;
  ...
  function _hash(TokenRatioCondition memory obj) internal pure returns (bytes32) {
    return keccak256(
      abi.encode(TokenRatioCondition_TYPEHASH, obj.lteToken0RatioX64, obj.gteToken0RatioX64)
    );
  }
  ...
  // );
  bytes32 constant Condition_TYPEHASH =
    0xaf36b8bda8212b5328e48351dce631ba51b3a66e23916e5bb6bbd603d2d06f08;
  ...
  // );
  bytes32 constant TickOffsetAction_TYPEHASH =
    0xf5f25bd65589108507b815014b323a5f159027eba9a477039a198a5f7fc368fc;
  ...
  function _hash(TickOffsetAction memory obj) internal pure returns (bytes32) {
    return
      keccak256(abi.encode(TickOffsetAction_TYPEHASH, obj.tickLowerOffset, obj.tickUpperOffset));
  }
  ...
  // );
  bytes32 constant PriceOffsetAction_TYPEHASH =
    0x0a6de33fb4ce9e036ea5aa72e73288d926400e8cc438f63c7c1c84b392c5801c;
  ...
  // );
  bytes32 constant TokenRatioAction_TYPEHASH =
    0x2d91584261cab64f66268846e106be0b9e325f19b0457d3be9790bff2e4d9259;
  ...
  // keccak256(
  //     "RebalanceAction(int256 maxGasProportionX64,int256 swapSlippageX64,int256
  // liquiditySlippageX64,string type,TickOffsetAction tickOffsetAction,PriceOffsetAction
  // priceOffsetAction,TokenRatioAction tokenRatioAction)PriceOffsetAction(uint32 baseToken,int160
  // lowerOffsetSqrtPriceX96,int160 upperOffsetSqrtPriceX96)TickOffsetAction(uint32
  // tickLowerOffset,uint32 tickUpperOffset)TokenRatioAction(uint32 tickWidth,int256
  // token0RatioX64)"
  // );
  bytes32 constant RebalanceAction_TYPEHASH =
    0xe862ada4db7ad1d390d5445cf9eae9093553a68a1c33bdc043a9b9868c555579;
  ...
  // keccak256(
  //     "RebalanceConfig(Condition rebalanceCondition,RebalanceAction
  // rebalanceAction,RebalanceAutoCompound autoCompound,bool recurring)Condition(string type,int160
  // sqrtPriceX96,int64 timeBuffer,TickOffsetCondition tickOffsetCondition,PriceOffsetCondition
  // priceOffsetCondition,TokenRatioCondition tokenRatioCondition)PriceOffsetAction(uint32
  // baseToken,int160 lowerOffsetSqrtPriceX96,int160
  // upperOffsetSqrtPriceX96)PriceOffsetCondition(uint32 baseToken,uint256
  // gteOffsetSqrtPriceX96,uint256 lteOffsetSqrtPriceX96)RebalanceAction(int256
  // maxGasProportionX64,int256 swapSlippageX64,int256 liquiditySlippageX64,string
  ...
  // );
  bytes32 constant RebalanceConfig_TYPEHASH =
    0xa595ef3200e4f62a94e521635728388988c00fa41a2fe6662a35a989b84c8507;
  ...
  // );
  bytes32 constant RangeOrderCondition_TYPEHASH =
    0xb6800e34595dae872617c5005f10a6a9e2b6a2520654db474bf4750fdd70a0c8;
  ...
  function _hash(RangeOrderCondition memory obj) internal pure returns (bytes32) {
    return keccak256(
      abi.encode(
        RangeOrderCondition_TYPEHASH, obj.zeroToOne, obj.gteTickAbsolute, obj.lteTickAbsolute
      )
    );
  }
  ...
  // withdrawSlippageX64)"
  // );
  bytes32 constant RangeOrderAction_TYPEHASH =
    0xf512215c27c5930c08d4f9d3f8d89d9b5735fb786bebf2231b3e88df5c4015d9;
  ...
  // lteTickAbsolute)"
  // );
  bytes32 constant RangeOrderConfig_TYPEHASH =
    0x896dec1198540e9a29dda867832b7bb119f2cec50527c0f5ee63ef305b0f539a;
  ...
  // );
  bytes32 constant FeeBasedCondition_TYPEHASH =
    0x0db5bdb29ccc0083eec5fc69273aba7a8fa98c12cb39bfa1377ade34a3b76e41;
  ...
  // );
  bytes32 constant TimeBasedCondition_TYPEHASH =
    0xf75b2fc8dbd0e2a1eccdee6280f192941a296b909b47921d1a7c7cfd48993252;
  ...
  // swapSlippageX64)"
  // );
  bytes32 constant AutoCompoundAction_TYPEHASH =
    0xe17b1ff10b4c0a0b457f201ae45a54a25ec9d424f9f0e068502ea1eab65d6e0e;
  ...
  // );
  bytes32 constant AutoCompoundConfig_TYPEHASH =
    0xbf8ab0c4189cfff5a6148a64201555fddbb74f69f3c9ed9673c79357a2c77217;
  ...
  function _hash(AutoCompoundConfig memory obj) internal pure returns (bytes32) {
    return
      keccak256(abi.encode(AutoCompoundConfig_TYPEHASH, _hash(obj.condition), _hash(obj.action)));
  }
  ...
  // lteTickOffset)TokenRatioCondition(int256 lteToken0RatioX64,int256 gteToken0RatioX64)"
  // );
  bytes32 constant AutoExitConfig_TYPEHASH =
    0x12abd614ffecf2dd5f160268162f92b4228cb34287cce8936339e98be3db7a86;
  ...
  // );
  bytes32 constant AutoExitAction_TYPEHASH =
    0x335b4a1f07e5a10cc856257ff4116d238ebc816eb0189c48ede23eab0ba1b164;
  ...
  // keccak256(
  //     "OrderConfig(RebalanceConfig rebalanceConfig,RangeOrderConfig
  // rangeOrderConfig,AutoCompoundConfig autoCompoundConfig,AutoExitConfig
  // autoExitConfig)AutoCompoundAction(int256 maxGasProportionX64,int256 poolSlippageX64,int256
  // swapSlippageX64)AutoCompoundCondition(string type,FeeBasedCondition
  // feeBasedCondition,TimeBasedCondition
  // timeBasedCondition)AutoCompoundConfig(AutoCompoundCondition condition,AutoCompoundAction
  // action)AutoExitAction(int256 maxGasProportionX64,int256 swapSlippageX64,int256
  // liquiditySlippageX64,address tokenOutAddress)AutoExitConfig(Condition condition,AutoExitAction
  // action)Condition(string type,int160 sqrtPriceX96,int64 timeBuffer,TickOffsetCondition
  // tickOffsetCondition,PriceOffsetCondition priceOffsetCondition,TokenRatioCondition
  // tokenRatioCondition)FeeBasedCondition(int256 minFeeEarnedUsdX64)PriceOffsetAction(uint32
  // baseToken,int160 lowerOffsetSqrtPriceX96,int160
  // upperOffsetSqrtPriceX96)PriceOffsetCondition(uint32 baseToken,uint256
  // gteOffsetSqrtPriceX96,uint256 lteOffsetSqrtPriceX96)RangeOrderAction(int256
  // maxGasProportionX64,int256 swapSlippageX64,int256 withdrawSlippageX64)RangeOrderCondition(bool
  // zeroToOne,int32 gteTickAbsolute,int32 lteTickAbsolute)RangeOrderConfig(RangeOrderCondition
  // condition,RangeOrderAction action)RebalanceAction(int256 maxGasProportionX64,int256
  // swapSlippageX64,int256 liquiditySlippageX64,string type,TickOffsetAction
  ...
  // tickWidth,int256 token0RatioX64)TokenRatioCondition(int256 lteToken0RatioX64,int256
  // gteToken0RatioX64)"
  // );
  bytes32 constant OrderConfig_TYPEHASH =
    0x5697d3035f19beb9868f849a8299e5c537a4c0359a4de82d07077a2bb857f3bf;
  ...
  // keccak256(
  //     "Order(int64 chainId,address nfpmAddress,uint256 tokenId,string orderType,OrderConfig
  // config,int64 signatureTime)AutoCompoundAction(int256 maxGasProportionX64,int256
  // poolSlippageX64,int256 swapSlippageX64)AutoCompoundCondition(string type,FeeBasedCondition
  // feeBasedCondition,TimeBasedCondition
  // timeBasedCondition)AutoCompoundConfig(AutoCompoundCondition condition,AutoCompoundAction
  // action)AutoExitAction(int256 maxGasProportionX64,int256 swapSlippageX64,int256
  // liquiditySlippageX64,address tokenOutAddress)AutoExitConfig(Condition condition,AutoExitAction
  ...
  // rebalanceConfig,RangeOrderConfig rangeOrderConfig,AutoCompoundConfig
  // autoCompoundConfig,AutoExitConfig autoExitConfig)PriceOffsetAction(uint32 baseToken,int160
  // lowerOffsetSqrtPriceX96,int160 upperOffsetSqrtPriceX96)PriceOffsetCondition(uint32
  // baseToken,uint256 gteOffsetSqrtPriceX96,uint256 lteOffsetSqrtPriceX96)RangeOrderAction(int256
  // maxGasProportionX64,int256 swapSlippageX64,int256 withdrawSlippageX64)RangeOrderCondition(bool
  // zeroToOne,int32 gteTickAbsolute,int32 lteTickAbsolute)RangeOrderConfig(RangeOrderCondition
  // condition,RangeOrderAction action)RebalanceAction(int256 maxGasProportionX64,int256
  // swapSlippageX64,int256 liquiditySlippageX64,string type,TickOffsetAction
  ...
  bytes32 constant Order_TYPEHASH =
    0xe90c3305b073b571e7a0d9f03c551c07c8a7b94927ec80f7a2a5e4282b2153fa;
