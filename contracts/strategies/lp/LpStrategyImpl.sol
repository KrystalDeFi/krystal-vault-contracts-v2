...
contract LpStrategyImpl is Initializable, ReentrancyGuardUpgradeable, ILpStrategy {
  ...
  function initialize(address _principalToken, address _optimalSwapper) public initializer {
  ...
  function convert(Asset[] memory assets, bytes calldata data)
    external
    nonReentrant
    returns (Asset[] memory returnAssets)
  {
  ...
  /// @return returnAssets The assets that were returned to the msg.sender
  function mintPosition(Asset[] memory assets, MintPositionParams memory params)
    internal
    returns (Asset[] memory returnAssets)
  {
    require(assets.length == 2, InvalidNumberOfAssets());
  ...
  function swapAndMintPosition(Asset[] memory assets, SwapAndMintPositionParams memory params)
    internal
    returns (Asset[] memory returnAssets)
  {
    require(assets.length == 1, InvalidNumberOfAssets());
  ...
  function _mintPosition(Asset[] memory assets, MintPositionParams memory params)
    internal
    returns (Asset[] memory returnAssets)
  {
    (Asset memory token0, Asset memory token1) =
  ...
  /// @return returnAssets The assets that were returned to the msg.sender
  function increaseLiquidity(Asset[] memory assets, IncreaseLiquidityParams memory params)
    internal
    returns (Asset[] memory returnAssets)
  {
    require(assets.length == 3, InvalidNumberOfAssets());
  ...
  function _increaseLiquidity(Asset[] memory assets, IncreaseLiquidityParams memory params)
    internal
    returns (Asset[] memory returnAssets)
  {
    ...
    returnAssets = new Asset[](3);
    returnAssets[0] =
      Asset(AssetType.ERC20, address(0), token0.token, 0, token0.amount - amount0Added);
    returnAssets[1] =
      Asset(AssetType.ERC20, address(0), token1.token, 0, token1.amount - amount1Added);
  ...
  /// @return returnAssets The assets that were returned to the msg.sender
  function decreaseLiquidity(Asset[] memory assets, DecreaseLiquidityParams memory params)
    internal
    returns (Asset[] memory returnAssets)
  {
    require(assets.length == 1, InvalidNumberOfAssets());
  ...
  function _decreaseLiquidity(Asset memory lpAsset, DecreaseLiquidityParams memory params)
    internal
    returns (Asset[] memory returnAssets)
  {
  ...
  function _optimalSwapFromPrinciple(
    ...
    (uint256 amount0, uint256 amount1) =
      principalToken == token0 ? (amount, 0) : (uint256(0), amount);
  ...
  function getUnderlyingAssets(Asset memory asset)
    external
    view
    returns (Asset[] memory underlyingAssets)
  {
    require(asset.strategy == address(this), InvalidAsset());
