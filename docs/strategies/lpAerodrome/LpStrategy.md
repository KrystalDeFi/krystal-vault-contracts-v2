...
```solidity
contract IAerodromeLpValidator validator
```
...
```solidity
function swapAndMintPosition(struct AssetLib.Asset[] assets, struct IAerodromeLpStrategy.SwapAndMintPositionParams params, struct ICommon.VaultConfig vaultConfig) internal returns (struct AssetLib.Asset[] returnAssets)
```
...
| params | struct IAerodromeLpStrategy.SwapAndMintPositionParams | The parameters for swapping and minting the position |
| vaultConfig | struct ICommon.VaultConfig | The vault configuration |
...
```solidity
function _mintPosition(struct ICommon.VaultConfig vaultConfig, struct AssetLib.Asset[] assets, struct IAerodromeLpStrategy.MintPositionParams params) internal returns (struct AssetLib.Asset[] returnAssets)
```
...
| params | struct IAerodromeLpStrategy.MintPositionParams | The parameters for minting the position |
...
```solidity
function swapAndIncreaseLiquidity(struct AssetLib.Asset[] assets, struct IAerodromeLpStrategy.SwapAndIncreaseLiquidityParams params, struct ICommon.VaultConfig vaultConfig) internal returns (struct AssetLib.Asset[] returnAssets)
```
...
| params | struct IAerodromeLpStrategy.SwapAndIncreaseLiquidityParams | The parameters for swapping and increasing the liquidity |
| vaultConfig | struct ICommon.VaultConfig | The vault configuration |
...
```solidity
function _increaseLiquidity(struct AssetLib.Asset[] assets, struct IAerodromeLpStrategy.IncreaseLiquidityParams params) internal returns (struct AssetLib.Asset[] returnAssets)
```
...
| params | struct IAerodromeLpStrategy.IncreaseLiquidityParams | The parameters for increasing the liquidity |
...
```solidity
function decreaseLiquidityAndSwap(struct AssetLib.Asset[] assets, struct IAerodromeLpStrategy.DecreaseLiquidityAndSwapParams params, struct ICommon.VaultConfig vaultConfig, struct ICommon.FeeConfig feeConfig) internal returns (struct AssetLib.Asset[] returnAssets)
```
...
| params | struct IAerodromeLpStrategy.DecreaseLiquidityAndSwapParams | The parameters for decreasing the liquidity and swapping |
| vaultConfig | struct ICommon.VaultConfig | The vault configuration |
| feeConfig | struct ICommon.FeeConfig | The fee configuration |
...
```solidity
function _decreaseLiquidity(struct AssetLib.Asset lpAsset, struct IAerodromeLpStrategy.DecreaseLiquidityParams params, struct ICommon.FeeConfig feeConfig, address principalToken, bool allowDeposit) internal returns (struct AssetLib.Asset[] returnAssets)
```
...
| params | struct IAerodromeLpStrategy.DecreaseLiquidityParams | The parameters for decreasing the liquidity |
| feeConfig | struct ICommon.FeeConfig | The fee configuration |
...
```solidity
function swapAndRebalancePosition(struct AssetLib.Asset[] assets, struct IAerodromeLpStrategy.SwapAndRebalancePositionParams params, struct ICommon.VaultConfig vaultConfig, struct ICommon.FeeConfig feeConfig) internal returns (struct AssetLib.Asset[] returnAssets)
```
...
| params | struct IAerodromeLpStrategy.SwapAndRebalancePositionParams | The parameters for swapping and rebalancing the position |
| vaultConfig | struct ICommon.VaultConfig | The vault configuration |
| feeConfig | struct ICommon.FeeConfig | The fee configuration |
...
```solidity
function swapAndCompound(struct AssetLib.Asset[] assets, struct IAerodromeLpStrategy.SwapAndCompoundParams params, struct ICommon.VaultConfig vaultConfig, struct ICommon.FeeConfig feeConfig) internal returns (struct AssetLib.Asset[] returnAssets)
```
...
| params | struct IAerodromeLpStrategy.SwapAndCompoundParams | The parameters for swapping and compounding the position |
...
```solidity
function _optimalSwapFromPrincipal(struct IAerodromeLpStrategy.SwapFromPrincipalParams params, bool checkPriceSanity) internal returns (uint256 amount0, uint256 amount1)
```
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| params | struct IAerodromeLpStrategy.SwapFromPrincipalParams | The parameters for swapping the principal token |
...
```solidity
function _swapToPrincipal(struct IAerodromeLpStrategy.SwapToPrincipalParams params, bool checkPriceSanity) internal returns (uint256 amountOut, uint256 amountInUsed)
```
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| params | struct IAerodromeLpStrategy.SwapToPrincipalParams | The parameters for swapping the token |
| checkPriceSanity | bool |  |
...
```solidity
function _getPoolForPosition(contract INonfungiblePositionManager nfpm, uint256 tokenId) internal view returns (contract ICLPool pool)
```
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| pool | contract ICLPool | The pool for the position |
...
```solidity
function _getFeeGrowthInside(contract ICLPool pool, int24 tickLower, int24 tickUpper, int24 tickCurrent) internal view returns (uint256 feeGrowthInside0X128, uint256 feeGrowthInside1X128)
```
