...
contract PrivateVaultIntegrationTest is TestCommon, IERC721Receiver {
  ...
  function _unstakeFromMasterChef(uint256 tokenId) internal {
    _unstakeFromMasterChefWithFee(tokenId, 0, 0, false);
  }
  ...
  function _unstakeFromMasterChefWithFee(
    ...
    bytes memory strategyCallData = abi.encodeWithSelector(
      PancakeV3FarmingStrategy.withdraw.selector, tokenId, rewardFeeX64, gasFeeX64, vaultOwnerAsRecipient
    );
  ...
  function _claimMasterChefRewards(uint256 tokenId) internal {
    _claimMasterChefRewardsWithFee(tokenId, 0, 0, false);
  }
  ...
  function _claimMasterChefRewardsWithFee(
    ...
    bytes memory strategyCallData = abi.encodeWithSelector(
      PancakeV3FarmingStrategy.harvest.selector, tokenId, rewardFeeX64, gasFeeX64, vaultOwnerAsRecipient
    );
  ...
  function test_PancakeV3Farming_HarvestFeeCollection() public {
    ...
    _claimMasterChefRewardsWithFee(tokenId, rewardFeeX64, gasFeeX64, false);
  ...
  function test_PancakeV3Farming_WithdrawFeeCollection() public {
    ...
    _unstakeFromMasterChefWithFee(tokenId, rewardFeeX64, gasFeeX64, false);
  ...
  function test_PancakeV3Farming_HarvestToVaultOwner() public {
    ...
    _claimMasterChefRewardsWithFee(tokenId, 0, 0, true);
  ...
  function test_PancakeV3Farming_WithdrawToVaultOwner() public {
    ...
    _unstakeFromMasterChefWithFee(tokenId, 0, 0, true);
  ...
  function test_PancakeV3Farming_Error_UnstakeNonExistentNFT() public {
    ...
    bytes memory strategyCallData =
      abi.encodeWithSelector(PancakeV3FarmingStrategy.withdraw.selector, nonExistentTokenId, 0, 0, false);
  ...
  function test_PancakeV3Farming_Error_ClaimRewardsNonExistentNFT() public {
    ...
    bytes memory strategyCallData =
      abi.encodeWithSelector(PancakeV3FarmingStrategy.harvest.selector, nonExistentTokenId, 0, 0, false);
