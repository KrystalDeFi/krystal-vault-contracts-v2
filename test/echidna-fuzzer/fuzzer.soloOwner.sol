...
In this fuzzer, the owner initializes the vault and the player1 & player 2 deposits. The bighand player swapped with an
amount.
...
contract VaultFuzzerSoloOwner {
  ...
  //     bighandplayer.doSwap(token0AddressIsTokenPrinciple ? TOKEN_PRINCIPAL : TOKEN_ANOTHER,
  // token0AddressIsTokenPrinciple ? TOKEN_ANOTHER : TOKEN_PRINCIPAL, token0Amount);
  // }
}
