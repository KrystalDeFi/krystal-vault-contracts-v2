...
contract Player {
  ...
  // https://etherscan.io/address/0x95a45a87dd4d3a1803039072f37e075f37b23d75#readContract
  ...
  function callSetStrategyConfig(
    address configManagerAddress,
    address validator,
    address principalTokenAddress,
    ILpValidator.LpStrategyConfig memory config
  ) public {
  ...
  function callAllocate(
    ...
    address tokenPrincipalAddress,
    address tokenAnotherAddress,
